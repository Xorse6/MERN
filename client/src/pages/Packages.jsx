...
const Packages = () => {
  ...
  return (
    <div >
        ...
        <div className='w-full flex justify-between items-center p-4 sm:p-6 sm:px-24 absolute top-0 bg-[url("/bg_img.png")] bg-cover bg-center'>
            <img onClick={()=>navigate('/')} src={assets.logo} alt="" className='top-10 w-10 sm:w-15 cursor-pointer' />
            <ul className='hidden text-lg sm:flex gap-9 text-gray-700 '>
